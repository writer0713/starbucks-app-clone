...
export default async function HomePage() {
  ...
  return (
    <div className="responsive w-full h-screen bg-white *:text-black">
      <div className="absolute flex items-center justify-between bottom-24 right-5 w-40 bg-primary px-6 py-3 rounded-full">
        <FontAwesomeIcon icon={faBicycle} className=" text-white size-8" />
        <p className=" text-white">Delivers</p>
      </div>

      <div className="flex flex-col gap-5 pt-20 px-4">
        <div className="mb-5">
          <h1 className="text-2xl font-bold">안녕하세요.</h1>
          <h1 className="text-2xl font-bold">스타벅스입니다.</h1>
        </div>

        <div className="flex justify-between items-center rounded-md border px-6 shadow-xl">
          ...
          <Image src={'/coffee.png'} alt="coffee" width={150} height={30} />
        </div>
